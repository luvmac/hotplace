// 지금 로그인된 세션정보를 활용해서 사용자에게 보여주도록 하기
        ...
        <dl className="divide-y divide-gray-100">
          ...
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <img 
                ...
                // 이미지가 없는경우에는 대체 이미지로 보여질 수 있도록 설정
                src={session?.user.image || '/images/markers/default.png'} /></dd>
          </div>
          <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
              <button 
                type="button"
                className="underline hover:text-gray-500" onClick={() => signOut()}>
                로그아웃
              </button>
            </dd>
          </div>
